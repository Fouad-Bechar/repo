        ...
        <div class="container">
          <div class="col-11">
              <div class="card text-center m-4 shadow p-3 mb-5 bg-white rounded">
                <div class="card-body">
                  <h4 class="card-title p-3">Reset my password</h4>
                    <div class="form-group">
                        <form action="password_change_post.php" method="POST">
                            ...
                            <br />
                            <input type="password" name="password_repeat" class="form-control" placeholder="retype password" required />
                            <button type="submit" class="btn btn-primary btn-lg m-3">Edit</button>
                        </form>
                    </div>
                </div>
              </div>
